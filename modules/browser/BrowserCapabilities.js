...
export default class BrowserCapabilities extends BrowserDetection {
     ...
     * allows the application to change the current codec used by each simulcast layer without a renegotiation.
     *
     * @returns {boolean}
     */
    supportsCodecSelectionAPI() {
        return this.isChromiumBased() && this.isEngineVersionGreaterThan(119);
    }
